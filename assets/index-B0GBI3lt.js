...
import { i as isServer, s as systemSetTimeoutZero, p as pendingThenable, a as sleep, b as isValidTimeout, t as timeoutManager, r as replaceData, n as noop, c as resolveEnabled, e as skipToken, f as resolveStaleTime, g as timeUntilStale, k as ensureQueryFn, l as shallowEqualObjects, m as addToStart, o as addToEnd, q as addConsumeAwareSignal, u as matchMutation, v as hashKey, w as replaceEqualDeep, x as hashQueryKeyByOptions, y as matchQuery, z as functionalUpdate, A as partialMatchKey, j as jsxRuntimeExports, B as shouldThrowError, h as hydrate } from './hydration-WfGuJdvK.js';
export { C as defaultShouldDehydrateMutation, D as defaultShouldDehydrateQuery, d as dehydrate, E as keepPreviousData } from './hydration-WfGuJdvK.js';
...
var QueryClientContext = host__loadShare__react__loadShare__.createContext(
  void 0
);
var useQueryClient = (queryClient) => {
  const client = host__loadShare__react__loadShare__.useContext(QueryClientContext);
  if (queryClient) {
    return queryClient;
  }
  if (!client) {
...
var IsRestoringContext = host__loadShare__react__loadShare__.createContext(false);
var useIsRestoring = () => host__loadShare__react__loadShare__.useContext(IsRestoringContext);
...
var QueryErrorResetBoundaryContext = host__loadShare__react__loadShare__.createContext(createValue());
var useQueryErrorResetBoundary = () => host__loadShare__react__loadShare__.useContext(QueryErrorResetBoundaryContext);
var QueryErrorResetBoundary = ({
  children
}) => {
  const [value] = host__loadShare__react__loadShare__.useState(() => createValue());
...
function useQueries({
  ...
  const defaultedQueries = host__loadShare__react__loadShare__.useMemo(
    () => queries.map((opts) => {
  ...
  const [observer] = host__loadShare__react__loadShare__.useState(
    () => new QueriesObserver(
      client,
      defaultedQueries,
      options
  ...
  host__loadShare__react__loadShare__.useSyncExternalStore(
    host__loadShare__react__loadShare__.useCallback(
...
var HydrationBoundary = ({
  ...
  const client = useQueryClient(queryClient);
  const optionsRef = host__loadShare__react__loadShare__.useRef(options);
  host__loadShare__react__loadShare__.useEffect(() => {
    optionsRef.current = options;
  });
  const hydrationQueue = host__loadShare__react__loadShare__.useMemo(() => {
    if (state) {
...
function useIsFetching(filters, queryClient) {
  const client = useQueryClient(queryClient);
  const queryCache = client.getQueryCache();
  return host__loadShare__react__loadShare__.useSyncExternalStore(
    host__loadShare__react__loadShare__.useCallback(
...
function useMutationState(options = {}, queryClient) {
  ...
  const optionsRef = host__loadShare__react__loadShare__.useRef(options);
  const result = host__loadShare__react__loadShare__.useRef(null);
...
function useMutation(options, queryClient) {
  ...
  const result = host__loadShare__react__loadShare__.useSyncExternalStore(
    host__loadShare__react__loadShare__.useCallback(
  ...
  const mutate = host__loadShare__react__loadShare__.useCallback(
