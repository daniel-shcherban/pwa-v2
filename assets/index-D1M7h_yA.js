...
var Scheduler = schedulerExports,
  React = host__loadShare__react__loadShare__,
  ReactDOM = host__loadShare__react_mf_2_dom__loadShare__;
...
function prepareToHydrateHostInstance(fiber) {
  ...
  checkForUnmatchedText(instance.textContent, type)
    ? (null != props.popover &&
      ...
      null != props.onClick && (instance.onclick = noop$1$1),
      (instance = true))
    : (instance = false);
...
function trackUsedThenable(thenableState, thenable, index) {
  ...
  void 0 === index
    ...
    : index !== thenable && (thenable.then(noop$1$1, noop$1$1), (thenable = index));
...
// dev uses dynamic import to separate chunks
    ...
    const res = initPromise.then(_ => loadShare("@ev/eva-container-api", {
